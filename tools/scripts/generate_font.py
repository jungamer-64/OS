...
def get_char_bitmap(char):
    ...
    bitmaps = {
        ...
        '4': [0x00, 0x00, 0x0C, 0x1C, 0x3C, 0x6C, 0xCC, 0xFE, 0x0C, 0x0C, 0x0C, 0x0C, 0x00, 0x00, 0x00, 0x00],
        '5': [0x00, 0x00, 0x7E, 0x60, 0x60, 0x7C, 0x06, 0x06, 0x06, 0x06, 0x66, 0x3C, 0x00, 0x00, 0x00, 0x00],
        '6': [0x00, 0x00, 0x3C, 0x66, 0x60, 0x60, 0x7C, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00, 0x00, 0x00, 0x00],
        '7': [0x00, 0x00, 0x7E, 0x06, 0x06, 0x06, 0x0C, 0x18, 0x18, 0x30, 0x30, 0x30, 0x00, 0x00, 0x00, 0x00],
        '8': [0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x3C, 0x66, 0x66, 0x66, 0x66, 0x3C, 0x00, 0x00, 0x00, 0x00],
        '9': [0x00, 0x00, 0x3C, 0x66, 0x66, 0x66, 0x3E, 0x06, 0x06, 0x06, 0x66, 0x3C, 0x00, 0x00, 0x00, 0x00],
...
def print_char_visual(char_code, bitmap):
    """Print ASCII art of the character to terminal."""
    print(f"Character: '{chr(char_code)}' ({char_code})")
    print("-" * 10)
    for row in bitmap:
        # Convert byte to binary string, replace 0 with space and 1 with #
        line = f"{row:08b}".replace('0', ' ').replace('1', '#')
        print(f"|{line}|")
    print("-" * 10)
...
if __name__ == '__main__':
    ...
    output_path = 'OS/assets/font/basic_8x16.bin'
    ...
    # Verify with visuals
    print('\nVerifying random characters (Visual Check):')
    
    # Check 'A' (65)
    offset_A = (65 - 32) * 16
    print_char_visual(65, font[offset_A:offset_A+16])
    
    # Check 'g' (103)
    offset_g = (103 - 32) * 16
    print_char_visual(103, font[offset_g:offset_g+16])