...
impl ScreenBuffer {
    ...
    /// Write a value to a specific cell within bounds.
    ///
    /// # Errors
    ///
    ...
    /// # Errors
    ///
    /// Returns `VgaError::InvalidPosition` if source or destination ranges are out of bounds.
    #[inline]
...
impl VgaWriter {
    ...
    fn clear_row(&self, row: usize) -> Result<(), VgaError> {
        self.ensure_ready()?;
